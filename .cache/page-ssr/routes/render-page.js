...
exports.components = {
  ...
  "component---src-pages-projects-js": function componentSrcPagesProjectsJs() {
    return __webpack_require__.e(/*! import() | component---src-pages-projects-js */ "component---src-pages-projects-js").then(__webpack_require__.bind(__webpack_require__, /*! ./../../../src/pages/projects.js?export=default */ "./src/pages/projects.js?export=default"));
  },
...
var plugins = [{
  ...
  options: {
    ...
    "cacheDigest": "3f636a749d361da5d062927d440f8ef6"
  }
}, {
...
function apiRunner(api, args, defaultReturn, argTransform) {
  ...
  plugins.forEach(function (plugin) {
    ...
    try {
      ...
      // TODO V4
      if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_1___default()(result) !== "undefined") {
        results.push(result);
      }
    } catch (e) {
...
function _apiRunnerAsync() {
  _apiRunnerAsync = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee(api, args, defaultReturn, argTransform) {
...
/* harmony import */ var _normalize_page_path__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./normalize-page-path */ "./.cache/normalize-page-path.js");
/* harmony import */ var _redirect_utils_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./redirect-utils.js */ "./.cache/redirect-utils.js");
...
var trimPathname = function trimPathname(rawPathname) {
  ...
  if (queryIndex !== -1) {
    var _rawPathname$split = rawPathname.split("?"),
      _rawPathname$split2 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0___default()(_rawPathname$split, 2),
  ...
  var trimmedPathname = (0,_strip_prefix__WEBPACK_IMPORTED_MODULE_2__["default"])(pathname, decodeURIComponent(""))
...
var findMatchPath = function findMatchPath(rawPathname) {
  ...
  var path = (0,_gatsbyjs_reach_router__WEBPACK_IMPORTED_MODULE_1__.pick)(pickPaths, trimmedPathname);
  if (path) {
    return (0,_normalize_page_path__WEBPACK_IMPORTED_MODULE_3__["default"])(path.route.originalPath);
  }
  return null;
};
...
var _findPath = function findPath(rawPathname) {
  ...
  var redirect = (0,_redirect_utils_js__WEBPACK_IMPORTED_MODULE_4__.maybeGetBrowserRedirect)(rawPathname);
  if (redirect) {
...
var cleanPath = function cleanPath(rawPathname) {
  ...
  foundPath = (0,_normalize_page_path__WEBPACK_IMPORTED_MODULE_3__["default"])(foundPath);
  return foundPath;
};
...
/* harmony import */ var react_server_dom_webpack__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! react-server-dom-webpack */ "./node_modules/react-server-dom-webpack/index.js");
/* harmony import */ var _prefetch__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./prefetch */ "./.cache/prefetch.js");
/* harmony import */ var _emitter__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./emitter */ "./.cache/emitter.js");
/* harmony import */ var _find_path__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./find-path */ "./.cache/find-path.js");
...
function _callSuper(t, o, e) { return o = _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_1___default()(o), _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_0___default()(t, _isNativeReflectConstruct() ? Reflect.construct(o, e || [], _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_1___default()(t).constructor) : o.apply(t, e)); }
function _isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }
function _superPropGet(t, o, e, r) { var p = _babel_runtime_helpers_get__WEBPACK_IMPORTED_MODULE_2___default()(_babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_1___default()(1 & r ? t.prototype : t), o, e); return 2 & r && "function" == typeof p ? function (t) { return p.apply(e, t); } : p; }
function _createForOfIteratorHelper(r, e) { var t = "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (!t) { if (Array.isArray(r) || (t = _unsupportedIterableToArray(r)) || e && r && "number" == typeof r.length) { t && (r = t); var _n = 0, F = function F() {}; return { s: F, n: function n() { return _n >= r.length ? { done: !0 } : { done: !1, value: r[_n++] }; }, e: function e(r) { throw r; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var o, a = !0, u = !1; return { s: function s() { t = t.call(r); }, n: function n() { var r = t.next(); return a = r.done, r; }, e: function e(r) { u = !0, o = r; }, f: function f() { try { a || null == t["return"] || t["return"](); } finally { if (u) throw o; } } }; }
function _unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return _arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? _arrayLikeToArray(r, a) : void 0; } }
function _arrayLikeToArray(r, a) { (null == a || a > r.length) && (a = r.length); for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e]; return n; }
...
var createPageDataUrl = function createPageDataUrl(rawPath) {
  var _rawPath$split = rawPath.split("?"),
    _rawPath$split2 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_9___default()(_rawPath$split, 2),
...
var doesConnectionSupportPrefetch = function doesConnectionSupportPrefetch() {
  if ("connection" in navigator && _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_8___default()(navigator.connection) !== "undefined") {
...
var BaseLoader = /*#__PURE__*/function () {
  function BaseLoader(loadComponent, matchPaths) {
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_5___default()(this, BaseLoader);
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(this, "inFlightNetworkRequests", new Map());
    ...
    (0,_find_path__WEBPACK_IMPORTED_MODULE_13__.setMatchPaths)(matchPaths);
  }
  return _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_6___default()(BaseLoader, [{
    key: "memoizedGet",
    ...
    value: function loadPageDataJson(rawPath) {
      var _this4 = this;
      var pagePath = (0,_find_path__WEBPACK_IMPORTED_MODULE_13__.findPath)(rawPath);
    ...
    value: function findMatchPath(rawPath) {
      return (0,_find_path__WEBPACK_IMPORTED_MODULE_13__.findMatchPath)(rawPath);
    }
    ...
    value: function loadPage(rawPath) {
      ...
      var inFlightPromise = Promise.all(loadDataPromises).then(function (allData) {
        var _allData = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_9___default()(allData, 3),
        ...
        return Promise.all(dedupedSliceNames.map(function (sliceName) {
          ...
          var slices = [];
          var dedupedStaticQueryHashes = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_4___default()(pageStaticQueryHashes);
          ...
          var componentChunkPromises = Promise.all(loadChunkPromises).then(function (components) {
            var _components = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_9___default()(components, 3),
            ...
            if (finalResult.status !== PageResourceStatus.Error) {
              ...
              if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_8___default()(rscDataResponse === null || rscDataResponse === void 0 ? void 0 : rscDataResponse.payload) === "string") {
                ...
                return waitForResponse((0,react_server_dom_webpack__WEBPACK_IMPORTED_MODULE_10__.createFromReadableStream)(readableStream)).then(function (result) {
          ...
          return Promise.all([componentChunkPromises, staticQueryBatchPromise]).then(function (_ref2) {
            var _ref3 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_9___default()(_ref2, 2),
            ...
            if (pageResources) {
              ...
              _emitter__WEBPACK_IMPORTED_MODULE_12__["default"].emit("onPostLoadPageResources", {
                page: payload,
    ...
    value: function prefetch(pagePath) {
      ...
      abortC.signal.addEventListener("abort", function () {
        var index = _this8.prefetchQueued.findIndex(function (_ref4) {
          var _ref5 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_9___default()(_ref4, 1),
            p = _ref5[0];
          return p === pagePath;
        });
    ...
    value: function _processNextPrefetchBatch() {
      ...
      idleCallback(function () {
        ...
        var prefetches = Promise.all(toPrefetch.map(function (_ref6) {
          var _ref7 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_9___default()(_ref6, 2),
            pagePath = _ref7[0],
            dPromise = _ref7[1];
          ...
          return _this9.doPrefetch((0,_find_path__WEBPACK_IMPORTED_MODULE_13__.findPath)(pagePath)).then(function () {
    ...
    value: function doPrefetch(pagePath) {
      ...
      if (false) {} else {
        return (0,_prefetch__WEBPACK_IMPORTED_MODULE_11__["default"])(pageDataUrl, {
          crossOrigin: "anonymous",
          as: "fetch"
        }).then(function () {
          return (
...
var ProdLoader = /*#__PURE__*/function (_BaseLoader2) {
  function ProdLoader(asyncRequires, matchPaths, pageData) {
    var _this12;
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_5___default()(this, ProdLoader);
    ...
    if (pageData) {
      _this12.pageDataDb.set((0,_find_path__WEBPACK_IMPORTED_MODULE_13__.findPath)(pageData.path), {
  ...
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_3___default()(ProdLoader, _BaseLoader2);
  return _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_6___default()(ProdLoader, [{
    key: "doPrefetch",
    value: function doPrefetch(pagePath) {
      return _superPropGet(ProdLoader, "doPrefetch", this, 3)([pagePath]).then(function (result) {
        ...
        return Promise.all(componentUrls.map(_prefetch__WEBPACK_IMPORTED_MODULE_11__["default"])).then(function () {
          return pageData;
        });
      });
    }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function (pathAndSearch) {
  ...
  var _pathAndSearch$split = pathAndSearch.split("?"),
    _pathAndSearch$split2 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0___default()(_pathAndSearch$split, 2),
...
var support = function support(feature) {
  if ((typeof document === "undefined" ? "undefined" : _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(document)) === "undefined") {
    return false;
  }
  var fakeLink = document.createElement("link");
  try {
    if (fakeLink.relList && _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(fakeLink.relList.supports) === "function") {
...
/* harmony import */ var _slice_server_slice__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./slice/server-slice */ "./.cache/slice/server-slice.js");
/* harmony import */ var _slice_inline_slice__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./slice/inline-slice */ "./.cache/slice/inline-slice.js");
/* harmony import */ var _slice_context__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./slice/context */ "./.cache/slice/context.js");
"use client";
...
function Slice(props) {
  if (true) {
    ...
    var slicesContext = (0,react__WEBPACK_IMPORTED_MODULE_9__.useContext)(_slice_context__WEBPACK_IMPORTED_MODULE_12__.SlicesContext);
    ...
    if (slicesContext.renderEnvironment === "server") {
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_9___default().createElement(_slice_server_slice__WEBPACK_IMPORTED_MODULE_10__.ServerSlice, internalProps);
    } else if (slicesContext.renderEnvironment === "browser") {
      // in the browser, we'll just render the component as is
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_9___default().createElement(_slice_inline_slice__WEBPACK_IMPORTED_MODULE_11__.InlineSlice, internalProps);
...
var SlicePropsError = /*#__PURE__*/function (_Error) {
  function SlicePropsError(inBrowser, sliceName, propErrors, renderedByLocation) {
    var _this;
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_3___default()(this, SlicePropsError);
    ...
    if (inBrowser) {
      ...
      var fullStack = react__WEBPACK_IMPORTED_MODULE_9___default().__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactDebugCurrentFrame.getCurrentStack();
  ...
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_6___default()(SlicePropsError, _Error);
  return _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(SlicePropsError);
...
var _validateSliceProps = function validateSliceProps(props) {
  ...
  for (var _i = 0, _Object$entries = Object.entries(props); _i < _Object$entries.length; _i++) {
    ...
    if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(value) === "function") {
      errors[propPath] = _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(value);
    } else if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(value) === "object" && seenObjects.indexOf(value) <= 0) {
...
var InlineSlice = function InlineSlice(_ref) {
  var sliceName = _ref.sliceName,
    ...
    sliceProps = _babel_runtime_helpers_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_1___default()(_ref, _excluded);
  var slicesMap = (0,react__WEBPACK_IMPORTED_MODULE_2__.useContext)(_context__WEBPACK_IMPORTED_MODULE_3__.SlicesMapContext);
  var slicesResultsMap = (0,react__WEBPACK_IMPORTED_MODULE_2__.useContext)(_context__WEBPACK_IMPORTED_MODULE_3__.SlicesResultsContext);
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(slice.component, _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({
...
var getSliceId = function getSliceId(sliceName, sliceProps) {
  ...
  var propsString = (0,gatsby_core_utils_create_content_digest__WEBPACK_IMPORTED_MODULE_2__.createContentDigest)(sliceProps);
...
var ServerSlice = function ServerSlice(_ref) {
  var sliceName = _ref.sliceName,
    allowEmpty = _ref.allowEmpty,
    children = _ref.children,
    sliceProps = _babel_runtime_helpers_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_0___default()(_ref, _excluded);
  var slicesMap = (0,react__WEBPACK_IMPORTED_MODULE_1__.useContext)(_context__WEBPACK_IMPORTED_MODULE_3__.SlicesMapContext);
  var slicesProps = (0,react__WEBPACK_IMPORTED_MODULE_1__.useContext)(_context__WEBPACK_IMPORTED_MODULE_3__.SlicesPropsContext);
  var concreteSliceName = slicesMap[sliceName];
...
var StaticQueryContext = (0,_context_utils__WEBPACK_IMPORTED_MODULE_2__.createServerOrClientContext)("StaticQuery", {});
function StaticQueryDataRenderer(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement((react__WEBPACK_IMPORTED_MODULE_1___default().Fragment), null, finalData && render(finalData), !finalData && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", null, "Loading (StaticQuery)"));
}
...
var StaticQuery = function StaticQuery(props) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(StaticQueryContext.Consumer, null, function (staticQueryData) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(StaticQueryDataRenderer, {
      data: data,
      query: query,
...
var useStaticQuery = function useStaticQuery(query) {
  var _context$query;
  if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()((react__WEBPACK_IMPORTED_MODULE_1___default().useContext)) !== "function" && "development" === "development") {
    // TODO(v5): Remove since we require React >= 18
    throw new Error("You're likely using a version of React that doesn't support Hooks\n" + "Please update React and ReactDOM to 16.8.0 or later to use the useStaticQuery hook.");
  }
  var context = react__WEBPACK_IMPORTED_MODULE_1___default().useContext(StaticQueryContext);
...
/***/ "react-dom/server":
/*!**************************************************************************************!*\
  !*** external "/Users/rsdmu/Desktop/rsdmu-website/node_modules/react-dom/server.js" ***!
  \**************************************************************************************/
/***/ ((module) => {

"use strict";
module.exports = require("/Users/rsdmu/Desktop/rsdmu-website/node_modules/react-dom/server.js");

/***/ }),

/***/ "react":
/*!*********************************************************************************!*\
  !*** external "/Users/rsdmu/Desktop/rsdmu-website/node_modules/react/index.js" ***!
  \*********************************************************************************/
/***/ ((module) => {

"use strict";
module.exports = require("/Users/rsdmu/Desktop/rsdmu-website/node_modules/react/index.js");
